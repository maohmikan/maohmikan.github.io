...
(function (ext) {
    ...
    var descriptor = {
        blocks: [
          ...
          ['r', '%m.blockName', 'block_name[0]', 'ダイヤブロック'],
        ...
        menus: {
            pos: ['x', 'y', 'z'],
            blockPos: ['abs', 'rel'],
            blockName: ['空気','石','草','土','丸石','オークの木材','溶岩','金ブロック','鉄ブロック','TNT','ダイヤブロック','オークのドア','木の感圧版','ソウルサンド','ジャック・オ・ランタン','エメラルドブロック','ビーコン','レッドストーンブロック','スライムブロック'],
            // mobName: ['羊', '馬', ],
        }
    };
